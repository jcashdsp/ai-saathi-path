...
export const TrueFalseQuiz: React.FC<TrueFalseQuizProps> = ({
  ...
  if (quizCompleted) {
    ...
    const encouragementMessage = isPassed ? culturalPhrases.excellent : culturalPhrases.keepGoing;
          ...
          <div className="space-y-2">
            ...
            <CardDescription>
              ...
              <div className="mt-2 text-sm">
                {isPassed 
                  ? `Score: ${finalScore}% - شاندار!` 
                  : `Score: ${finalScore}% - دوبارہ کوشش کریں!`
                }
              </div>
            </CardDescription>
          </div>
          ...
          {isPassed ? (
            <div className="space-y-3">
              ...
              <div className="text-sm text-cultural-emerald font-medium">
                بہت خوب! Keep up the excellent work! 🎉
              </div>
            </div>
          ) : (
            <div className="space-y-3">
